...
## [Download for Mac](https://github.com/adamjdavidson/magic8-firmware/releases/download/v0.2.1-guide2/Magic8-Firmware-0.2.1-mac.zip)
...
**Other information:** [Battery fitting and charging](docs/BATTERY.md) · [Release notes](https://github.com/adamjdavidson/magic8-firmware/releases/tag/v0.2.1-guide2) · [For maintainers](docs/RELEASE.md) · [Bundled software](THIRD_PARTY.md)
