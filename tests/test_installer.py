...
class InstallerTests(unittest.TestCase):
    ...
    def run_installer(self, status=0):
        env = dict(os.environ, INSTALLER_TEST_MARKER=str(self.root/'called'), INSTALLER_TEST_RESULT=str(status))
